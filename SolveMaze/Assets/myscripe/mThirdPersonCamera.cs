...
public class mThirdPersonCamera : MonoBehaviour {
...
private mThirdPersonController controller;
...
void  Awake (){
	...
	if (_target)
	{
		controller = _target.GetComponent<mThirdPersonController>();
	}
...
//	DebugDrawStuff();
	...
	temp.z=cameraTransform.position.z;
...
void  SetUpRotation ( Vector3 centerPos ,   Vector3 headPos  ){
	...
	Ray centerRay= cameraTransform.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, 0.5f, 1.0f));
